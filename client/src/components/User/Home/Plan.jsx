  ...
  return (
    <div className=' flex max-w-[1400px] m-auto px-4 py-16 gird lg:grid-col-2  gap-4 '>
        ...
        <div className='flex flex-col h-full justify-center'>
            ...
            <div >
                <button onClick={()=>router.push('/room')} className='border-black rounded-full border py-2 hover:bg-black hover:text-white px-3 mr-4 hover:shadow-xl'>Learn More</button>
                <button className='bg-black bg-sky-600 rounded hover:bg-sky-800 py-2 px-3 xs:mt-4 text-white border-black hover:shadow-xl '>Book Now</button>
            </div>
        </div>
    </div>
  )
